...
def upgrade() -> None:
    ...
    sa.Column('typ', sa.Enum('client', 'author', 'admin', name='typ'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('client_id', sa.Integer(), nullable=False),
    sa.Column('subscription_model', sa.Enum('free', 'plus', 'premium', name='subscriptionenum'), nullable=False),
    sa.Column('start', sa.DateTime(), nullable=False),
    sa.Column('end', sa.DateTime(), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
...
def downgrade() -> None:
    ...
    sa.Column('is_supper_user', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False, nullable=False),
