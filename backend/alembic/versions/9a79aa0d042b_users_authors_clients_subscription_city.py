"""users - authors - clients - subscription - city

Revision ID: 9a79aa0d042b
Revises: 4ff5f36d48a8
Create Date: 2025-01-25 13:20:23.541090
...
def upgrade() -> None:
    ...
    sa.Column('typ', sa.Enum('client', 'author', name='typ'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
